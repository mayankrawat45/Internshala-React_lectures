    ...
    return (
        <div className='bg-gray-900 text-white'>
            <nav className='flex justify-between items-center px-12 py-4' >
                ...
                <ul className='flex'>
                    <div className='flex mx-4 items-center font-semibold'>
                        <span><IoSearch /></span>
                        <Link to='/' className='px-2' >Search</Link>
                    </div>
                    <div className='flex mx-4 items-center font-semibold'>
                        <span><BiSolidOffer/></span>
                        <Link to='/offer' className='px-2' >Offer</Link>
                    </div>
                    <div className='flex mx-4 items-center font-semibold'>
                    ...
                    <div className='flex mx-4 items-center font-semibold'>
                        <span><CgProfile /></span>
                        <Link to='/cart' className='px-2' >Cart</Link>
                    </div>
                    <div className='flex mx-4 items-center font-semibold'>
                        <span><IoIosCart /></span>
